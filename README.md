...
| [`R code to compare power between our and Yin model-2.R`](R%20code%20to%20compare%20power%20between%20our%20and%20Yin%20model-2.R) | Applies both tests to the EEG example for a selected signal strength and reports their rejection indicators. |
